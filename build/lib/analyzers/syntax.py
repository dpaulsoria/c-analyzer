...
def p_ROOT(p):
    ...
    ROOT : PREPROCESOR_DIRECTIVE
         ...
         | CHARACTERS
         | ARRAY_DECLARATION
        | DECIMAL_DECLARATION1
          |  INTEGER_DECLARATION1
           | DECLARATION1
           | DECLARATIONS1
        | ARGUMENTS1
       | FUNCTION_BODY
       | FUNCTION_DECLARATION_DECIMAL
        | FUNCTION_DECLARATION_INTEGER
        | DECLARATION_INTEGER
    """
    p[0] = ('ROOT', p[1])
...
def p_DECLARATION_INTEGER(p):
    """
    DECLARATION_INTEGER : INTEGER_TYPE VARNAME
    """
    p[0] = ('DECLARATION_INTEGER', p[1])
...
def p_FUNCTION_DECLARATION_INTEGER(p):
    """
    FUNCTION_DECLARATION_INTEGER : INTEGER_TYPE VARNAME LPAREN ARGUMENTS1 RPAREN FUNCTION_BODY
    """
    p[0] = ('FUNCTION_DECLARATION_INTEGER', p[1])


def p_FUNCTION_DECLARATION_DECIMAL(p):
    """
    FUNCTION_DECLARATION_DECIMAL : DECIMAL_TYPE VARNAME LPAREN ARGUMENTS1 RPAREN FUNCTION_BODY
    """
    p[0] = ('FUNCTION_DECLARATION_DECIMAL', p[1])


def p_FUNCTION_BODY(p):
    """
    FUNCTION_BODY : LCURL_BRACE EXPRESSIONS RETURN_STATEMENT RCURL_BRACE
                  | LCURL_BRACE EXPRESSIONS RCURL_BRACE
                  | LCURL_BRACE RCURL_BRACE
    """
...
def p_ARGUMENTS1(p):
    """
    ARGUMENTS1 : DECLARATIONS1 COMMA TIMES VARNAME
    """
    p[0] = ('ARGUMENTS1', p[1])
...
def p_DECLARATIONS1(p):
    ...
    DECLARATIONS1 : DECLARATION1
                  | DECLARATION1 COMMA DECLARATIONS1
    """
    p[0] = ('DECLARATIONS1', p[1])

def p_DECLARATION1(p):
    """
    DECLARATION1 : INTEGER_DECLARATION1
            | DECIMAL_DECLARATION1
    """
    p[0] = ('DECLARATION1', p[1])


def p_INTEGER_DECLARATION1(p):
    """
    INTEGER_DECLARATION1 : INTEGER_TYPE VARNAME
    """
    p[0] = ('INTEGER_DECLARATION1', p[1])

def p_DECIMAL_DECLARATION1(p):
    """
    DECIMAL_DECLARATION1 : DECIMAL_TYPE VARNAME
    """
    p[0] = ('DECIMAL_DECLARATION1', p[1])
